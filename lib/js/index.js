 ...
 * @param {Boolean} firstC 将返回的首字母置为"c"
 * @param {Nubmer} radix 生成uuid的基数(意味着返回的字符串都是这个基数),2-二进制,8-八进制,10-十进制,16-十六进制
 */
const guid = (len = 32, firstC = true, radix = null) => {
  const chars =
...
function date (dateTime = null, fmt = 'yyyy-mm-dd') {
  // 如果为null,则格式化当前时间
